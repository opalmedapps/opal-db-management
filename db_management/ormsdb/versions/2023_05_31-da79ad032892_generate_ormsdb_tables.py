...
def upgrade() -> None:
    ...
    sa.Column('LastReceivedSmsFetch', sa.TIMESTAMP(), server_default=sa.text('current_timestamp() ON UPDATE current_timestamp()'), nullable=False),
    sa.PrimaryKeyConstraint('System')
    )
    op.create_table('DiagnosisChapter',
    ...
    op.create_table('PatientLocation',
    ...
    sa.Column('IntendedAppointmentFlag', mysql.TINYINT(display_width=1), server_default=sa.text('0'), nullable=False),
    ...
    op.create_table('PatientLocationMH',
    sa.Column('PatientLocationSerNum', mysql.INTEGER(display_width=10), nullable=False, comment='This key comes from the PatientLocation table but it should be unique'),
    sa.Column('PatientLocationRevCount', mysql.INTEGER(display_width=3), nullable=False),
    sa.Column('AppointmentSerNum', mysql.INTEGER(display_width=10), nullable=False),
    sa.Column('CheckinVenueName', sa.String(length=50), nullable=False),
    sa.Column('ArrivalDateTime', sa.DateTime(), nullable=False),
    sa.Column('DichargeThisLocationDateTime', sa.TIMESTAMP(), server_default=sa.text('current_timestamp()'), nullable=False, comment='This is effectively the LastUpdated Column'),
    sa.Column('IntendedAppointmentFlag', mysql.TINYINT(display_width=1), server_default=sa.text('0'), nullable=False),
    sa.PrimaryKeyConstraint('PatientLocationSerNum')
    )
    op.create_index(op.f('ix_PatientLocationMH_AppointmentSerNum'), 'PatientLocationMH', ['AppointmentSerNum'], unique=False)
    op.create_table('ProfileColumnDefinition',
    ...
    op.create_table('ProfileColumns',
    ...
    op.create_table('ProfileOptions',
    ...
    op.create_table('TEMP_PatientQuestionnaireReview',
    ...
    op.create_index(op.f('ix_TEMP_PatientQuestionnaireReview_PatientSer'), 'TEMP_PatientQuestionnaireReview', ['PatientSer'], unique=False)
    op.create_table('DiagnosisCode',
    sa.Column('DiagnosisCodeId', mysql.INTEGER(display_width=11), nullable=False),
    sa.Column('DiagnosisChapterId', mysql.INTEGER(display_width=11), nullable=False),
    sa.Column('Code', sa.String(length=20), nullable=False),
    sa.Column('Category', sa.Text(), nullable=False),
    sa.Column('Description', sa.Text(), nullable=False),
    sa.ForeignKeyConstraint(['DiagnosisChapterId'], ['DiagnosisChapter.DiagnosisChapterId'], ),
    ...
    op.create_table('PatientHospitalIdentifier',
    ...
    sa.Column('LastModified', sa.DateTime(), server_default=sa.text('current_timestamp() ON UPDATE current_timestamp()'), nullable=False),
    sa.ForeignKeyConstraint(['HospitalId'], ['Hospital.HospitalId'], ),
    sa.ForeignKeyConstraint(['PatientId'], ['Patient.PatientSerNum'], ),
    sa.PrimaryKeyConstraint('PatientHospitalIdentifierId')
    )
    op.create_index('HospitalId_MedicalRecordNumber', 'PatientHospitalIdentifier', ['HospitalId', 'MedicalRecordNumber'], unique=True)
    op.create_index(op.f('ix_PatientHospitalIdentifier_PatientId'), 'PatientHospitalIdentifier', ['PatientId'], unique=False)
    op.create_table('PatientInsuranceIdentifier',
    ...
    sa.Column('DateAdded', sa.DateTime(), server_default=sa.text('current_timestamp()'), nullable=False),
    sa.Column('LastModified', sa.DateTime(), server_default=sa.text('current_timestamp() ON UPDATE current_timestamp()'), nullable=False),
    sa.ForeignKeyConstraint(['InsuranceId'], ['Insurance.InsuranceId'], ),
    sa.ForeignKeyConstraint(['PatientId'], ['Patient.PatientSerNum'], ),
    sa.PrimaryKeyConstraint('PatientInsuranceIdentifierId')
    )
    op.create_index('InsuranceId_InsuranceNumber', 'PatientInsuranceIdentifier', ['InsuranceId', 'InsuranceNumber'], unique=True)
    op.create_index(op.f('ix_PatientInsuranceIdentifier_PatientId'), 'PatientInsuranceIdentifier', ['PatientId'], unique=False)
    op.create_table('PatientMeasurement',
    ...
    sa.Column('LastUpdated', sa.TIMESTAMP(), server_default=sa.text('current_timestamp() ON UPDATE current_timestamp()'), nullable=False),
    sa.ForeignKeyConstraint(['PatientSer'], ['Patient.PatientSerNum'], ),
    ...
    op.create_table('SpecialityGroup',
    ...
    sa.Column('LastUpdated', sa.DateTime(), server_default=sa.text('current_timestamp() ON UPDATE current_timestamp()'), nullable=False),
    sa.ForeignKeyConstraint(['HospitalId'], ['Hospital.HospitalId'], ),
    ...
    op.create_table('AppointmentCode',
    ...
    sa.Column('LastModified', sa.DateTime(), server_default=sa.text('current_timestamp() ON UPDATE current_timestamp()'), nullable=False),
    sa.ForeignKeyConstraint(['SpecialityGroupId'], ['SpecialityGroup.SpecialityGroupId'], ),
    sa.PrimaryKeyConstraint('AppointmentCodeId')
    )
    op.create_index('AppointmentCode_SpecialityGroupId', 'AppointmentCode', ['AppointmentCode', 'SpecialityGroupId'], unique=True)
    op.create_index(op.f('ix_AppointmentCode_SpecialityGroupId'), 'AppointmentCode', ['SpecialityGroupId'], unique=False)
    op.create_table('ClinicHub',
    ...
    op.create_table('ClinicResources',
    ...
    sa.Column('ResourceName', sa.String(length=200), nullable=False, comment='Both Aria and Medivisit resources listed here'),
    sa.Column('SpecialityGroupId', mysql.INTEGER(display_width=11), nullable=False),
    sa.Column('SourceSystem', sa.String(length=50), nullable=False),
    sa.Column('LastModified', sa.TIMESTAMP(), server_default=sa.text('current_timestamp() ON UPDATE current_timestamp()'), nullable=False),
    sa.Column('Active', mysql.TINYINT(display_width=4), server_default=sa.text('1'), nullable=False, comment='1 = Active / 0 = Not Active'),
    sa.ForeignKeyConstraint(['SpecialityGroupId'], ['SpecialityGroup.SpecialityGroupId'], ),
    sa.PrimaryKeyConstraint('ClinicResourcesSerNum')
    )
    op.create_index('ClinicResources_SpecialityGroupId', 'ClinicResources', ['ResourceCode', 'SpecialityGroupId'], unique=True)
    ...
    op.create_index(op.f('ix_ClinicResources_SpecialityGroupId'), 'ClinicResources', ['SpecialityGroupId'], unique=False)
    op.create_table('DiagnosisSubcode',
    ...
    sa.Column('Description', sa.Text(), nullable=False),
    sa.ForeignKeyConstraint(['DiagnosisCodeId'], ['DiagnosisCode.DiagnosisCodeId'], ),
    ...
    sa.Column('Category', sa.Enum('PAB', 'Physician', 'Nurse', 'Checkout Clerk', 'Pharmacy', 'Treatment Machine'), nullable=False),
    sa.Column('SpecialityGroupId', mysql.INTEGER(display_width=11), nullable=False),
    sa.Column('LastUpdated', sa.TIMESTAMP(), server_default=sa.text('current_timestamp()'), nullable=False),
    sa.ForeignKeyConstraint(['SpecialityGroupId'], ['SpecialityGroup.SpecialityGroupId'], ),
    ...
    op.create_index('SpecialityGroupId_Type_Event_Language', 'SmsMessage', ['SpecialityGroupId', 'Type', 'Event', 'Language'], unique=True)
    op.create_index(op.f('ix_SmsMessage_Type'), 'SmsMessage', ['Type'], unique=False)
    op.create_table('ExamRoom',
    ...
    sa.ForeignKeyConstraint(['ClinicHubId'], ['ClinicHub.ClinicHubId'], ),
    ...
    op.create_table('IntermediateVenue',
    ...
    op.create_table('MediVisitAppointmentList',
    sa.Column('PatientSerNum', mysql.INTEGER(display_width=10), nullable=False),
    sa.Column('ClinicResourcesSerNum', mysql.INTEGER(display_width=11), nullable=False),
    ...
    sa.Column('AppointmentReminderSent', mysql.TINYINT(display_width=1), server_default=sa.text('0'), nullable=False),
    sa.Column('AppointmentCodeId', mysql.INTEGER(display_width=11), nullable=False),
    ...
    sa.ForeignKeyConstraint(['AppointmentCodeId'], ['AppointmentCode.AppointmentCodeId'], ),
    sa.ForeignKeyConstraint(['ClinicResourcesSerNum'], ['ClinicResources.ClinicResourcesSerNum'], ),
    sa.ForeignKeyConstraint(['PatientSerNum'], ['Patient.PatientSerNum'], ),
    ...
    op.create_index(op.f('ix_MediVisitAppointmentList_AppointSys'), 'MediVisitAppointmentList', ['AppointSys'], unique=False)
    op.create_index(op.f('ix_MediVisitAppointmentList_AppointmentCodeId'), 'MediVisitAppointmentList', ['AppointmentCodeId'], unique=False)
    op.create_index(op.f('ix_MediVisitAppointmentList_ClinicResourcesSerNum'), 'MediVisitAppointmentList', ['ClinicResourcesSerNum'], unique=False)
    op.create_index(op.f('ix_MediVisitAppointmentList_PatientSerNum'), 'MediVisitAppointmentList', ['PatientSerNum'], unique=False)
    op.create_index(op.f('ix_MediVisitAppointmentList_ScheduledDate'), 'MediVisitAppointmentList', ['ScheduledDate'], unique=False)
    op.create_index(op.f('ix_MediVisitAppointmentList_ScheduledDateTime'), 'MediVisitAppointmentList', ['ScheduledDateTime'], unique=False)
    op.create_index(op.f('ix_MediVisitAppointmentList_Status'), 'MediVisitAppointmentList', ['Status'], unique=False)
    op.create_table('PatientDiagnosis',
    ...
    sa.ForeignKeyConstraint(['DiagnosisSubcodeId'], ['DiagnosisSubcode.DiagnosisSubcodeId'], ),
    sa.ForeignKeyConstraint(['PatientSerNum'], ['Patient.PatientSerNum'], ),
    sa.PrimaryKeyConstraint('PatientDiagnosisId')
    )
    op.create_index(op.f('ix_PatientDiagnosis_DiagnosisSubcodeId'), 'PatientDiagnosis', ['DiagnosisSubcodeId'], unique=False)
    op.create_index(op.f('ix_PatientDiagnosis_PatientSerNum'), 'PatientDiagnosis', ['PatientSerNum'], unique=False)
    op.create_table('SmsAppointment',
    ...
    sa.ForeignKeyConstraint(['ClinicResourcesSerNum'], ['ClinicResources.ClinicResourcesSerNum'], ),
    sa.ForeignKeyConstraint(['SpecialityGroupId'], ['SpecialityGroup.SpecialityGroupId'], ),
    sa.ForeignKeyConstraint(['Type'], ['SmsMessage.Type'], ),
    sa.PrimaryKeyConstraint('SmsAppointmentId')
    )
    op.create_index('ClinicResourcesSerNum', 'SmsAppointment', ['ClinicResourcesSerNum', 'AppointmentCodeId'], unique=True)
