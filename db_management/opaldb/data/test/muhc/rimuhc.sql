...
(58,	0,	'',	'',	'Wednesday',	'Addams',	'wednesday_test',	NULL,	'Female',	'2009-02-13 00:00:00',	0,	14381234567,	0,	'wednesday@opalmedapps.ca',	'EN',	'ADAW09021399',	'3',	DATE_ADD(NOW(), INTERVAL -1 MONTH),	'2019-01-01 00:00:00',	0,	'',	'0000-00-00 00:00:00',	'',	'2023-05-25 00:00:00',	1,	NULL,	NULL);
...
-- Wednesday Pathology
INSERT INTO `Document` (`DocumentSerNum`, `CronLogSerNum`, `PatientSerNum`, `SourceDatabaseSerNum`, `DocumentId`, `AliasExpressionSerNum`, `ApprovedBySerNum`, `ApprovedTimeStamp`, `AuthoredBySerNum`, `DateOfService`, `Revised`, `ValidEntry`, `ErrorReasonText`, `OriginalFileName`, `FinalFileName`, `CreatedBySerNum`, `CreatedTimeStamp`, `TransferStatus`, `TransferLog`, `SessionId`, `DateAdded`, `ReadStatus`, `ReadBy`, `LastUpdated`) VALUES
(14,	NULL,	57,	1,	'56190000000000039165520',	8408,	890,	'2024-02-19 12:35:00',	890,	'2024-02-19 12:35:00',	'',	'Y',	'',	'wednesday_2024Feb19_pathology_rvh.pdf',	'wednesday_2024Feb19_pathology_rvh.pdf',	890,	'2024-02-19 14:35:00',	'T',	'Transfer successful',	'',	'2024-02-19 14:35:00',	0,	'[]',	'2024-02-19 14:35:00');

-- We add those records here to manually insert `Clinical Notes` documents for hospital-specific `muhc` demo purposes
-- Pebbles Note
INSERT INTO `Document` (`DocumentSerNum`, `CronLogSerNum`, `PatientSerNum`, `SourceDatabaseSerNum`, `DocumentId`, `AliasExpressionSerNum`, `ApprovedBySerNum`, `ApprovedTimeStamp`, `AuthoredBySerNum`, `DateOfService`, `Revised`, `ValidEntry`, `ErrorReasonText`, `OriginalFileName`, `FinalFileName`, `CreatedBySerNum`, `CreatedTimeStamp`, `TransferStatus`, `TransferLog`, `SessionId`, `DateAdded`, `ReadStatus`, `ReadBy`, `LastUpdated`) VALUES
(15,	NULL,	57,	1,	'56190000000000039165520',	99,	891,	'2023-10-14 12:36:00',	891,	'2023-10-14 12:36:00',	'',	'Y',	'',	'pebbles_2023Oct14_note_mch.pdf',	'pebbles_2023Oct14_note_mch.pdf',	891,	'2023-10-14 15:36:00',	'T',	'Transfer successful',	'',	'2023-10-14 15:36:00',	0,	'[]',	'2023-10-14 15:36:00');
-- Fred Note
INSERT INTO `Document` (`DocumentSerNum`, `CronLogSerNum`, `PatientSerNum`, `SourceDatabaseSerNum`, `DocumentId`, `AliasExpressionSerNum`, `ApprovedBySerNum`, `ApprovedTimeStamp`, `AuthoredBySerNum`, `DateOfService`, `Revised`, `ValidEntry`, `ErrorReasonText`, `OriginalFileName`, `FinalFileName`, `CreatedBySerNum`, `CreatedTimeStamp`, `TransferStatus`, `TransferLog`, `SessionId`, `DateAdded`, `ReadStatus`, `ReadBy`, `LastUpdated`) VALUES
(16,	NULL,	56,	1,	'56190000000000039165521',	99,	892,	'2023-10-21 12:35:00',	892,	'2023-10-21 12:35:00',	'',	'Y',	'',	'fred_2023Oct21_note_rvh.pdf',	'fred_2023Oct21_note_rvh.pdf',	892,	'2023-10-21 15:35:00',	'T',	'Transfer successful',	'',	'2023-10-21 15:35:00',	0,	'[]',	'2023-10-21 15:35:00');
