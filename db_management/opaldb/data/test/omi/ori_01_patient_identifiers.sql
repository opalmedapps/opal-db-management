...
(57,	0,	'',	'',	'Pebbles',	'Flintstone',	'pebbles_test',	NULL,	'Female',	CONCAT(DATE_FORMAT(DATE_SUB(NOW(), INTERVAL -9 YEAR), '%Y'), '-02-01 00:00:00'),	0,	14381234567,	0,	'pebbles@opalmedapps.ca',	'EN',	'FLIP15022299',	'3',	DATE_ADD(NOW(), INTERVAL -1 MONTH),	'2019-01-01 00:00:00',	0,	'',	'0000-00-00 00:00:00',	'',	'2023-05-25 00:00:00',	1,	NULL,	NULL),
(58,	0,	'',	'',	'Wednesday',	'Addams',	'wednesday_test',	NULL,	'Female',	CONCAT(DATE_FORMAT(DATE_SUB(NOW(), INTERVAL -15 YEAR), '%Y'), '-02-13 00:00:00'),	0,	14381234567,	0,	'wednesday@opalmedapps.ca',	'EN',	'ADAW09021399',	'3',	DATE_ADD(NOW(), INTERVAL -1 MONTH),	'2019-01-01 00:00:00',	0,	'',	'0000-00-00 00:00:00',	'',	'2023-05-25 00:00:00',	1,	NULL,	NULL);
