...
(55,	0,	'',	'',	'Mona',	    'Simpson',	'mona_test',	NULL,	'Female', '1940-03-15 00:00:00',	0,	5144758941,	0,	'mona@opalmedapps.ca',	'EN',	'SIMM40531599',	'1',	DATE_ADD(NOW(), INTERVAL -1 YEAR),	'2019-01-01 00:00:00',	1,	'Deceased',	DATE_ADD(NOW(), INTERVAL -2 YEAR),	'',	'2023-05-25 00:00:00',	1,	1,	CONVERT_TZ(DATE_ADD(CURRENT_DATE(), INTERVAL -1 YEAR), 'America/Toronto', 'UTC')),
-- convert date of death to UTC to match the datetime in the backend
(92, 43235, '1092300', '5024737', 'Laurie', 'Hendren', 'Pointer Lady', '', 'Female', '1958-12-13 00:00:00', 64, 5144415642, 1, 'laurie@opalmedapps.ca', 'EN', 'HENL58621319', '3', '2018-01-01 00:00:00', '2019-01-01 00:00:00', 0, 'Unlocked by Johns Request', CONVERT_TZ('2019-05-27 00:00:00', 'America/Toronto', 'UTC'), '', '2024-04-18 17:59:43', 0, NULL, NULL);
