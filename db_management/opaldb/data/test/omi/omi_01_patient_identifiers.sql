...
CONCAT(DATE_FORMAT(DATE_SUB(NOW(), INTERVAL -36 YEAR), '%Y'), '-10-01 00:00:00'),	0,	5144758941,	0,	'marge@opalmedapps.ca',	'EN',	'SIMM86600199',	'3',	DATE_ADD(NOW(), INTERVAL -2 MONTH),	'2019-01-01 00:00:00',	0,	'',	'0000-00-00 00:00:00',	'',	'2023-05-25 00:00:00',	1,	1,	DATE_ADD(NOW(), INTERVAL -2 MONTH)),
(52,	0,	'',	'',	'Homer',	'Simpson',	'homer_test',	NULL,	'Male',
CONCAT(DATE_FORMAT(DATE_SUB(NOW(), INTERVAL -39 YEAR), '%Y'), '-05-12 00:00:00'),	0,	4381234567,	0,	'homer@opalmedapps.ca',	'EN',	'SIMH83051299',	'3',	DATE_ADD(NOW(), INTERVAL -1 MONTH),	'2019-01-01 00:00:00',	1,	'',	'0000-00-00 00:00:00',	'',	'2023-05-25 00:00:00',	1,	1,	DATE_ADD(NOW(), INTERVAL -1 MONTH)),
