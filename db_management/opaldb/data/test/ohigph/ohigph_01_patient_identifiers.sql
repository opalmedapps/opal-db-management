...
(51,	0,	'',	'',	'Marge',	'Simpson',	'marge_test',	NULL,	'Female',	CONCAT(DATE_FORMAT(DATE_SUB(NOW(), INTERVAL -36 YEAR), '%Y'), '-10-01 00:00:00'),	0,	5144758941,	0,	'marge@opalmedapps.ca',	'EN',	'',	'3',	DATE_ADD(NOW(), INTERVAL -1 MONTH),	'2019-01-01 00:00:00',	0,	'',	'0000-00-00 00:00:00',	'',	'2023-05-25 00:00:00',	1,	1,	DATE_ADD(NOW(), INTERVAL -1 MONTH)),
