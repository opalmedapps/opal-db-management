...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['tableId'], ['definitionTable.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    ...
    sa.Column('lastUpdated', sa.TIMESTAMP(), server_default=sa.text('current_timestamp() ON UPDATE current_timestamp()'), nullable=False),
    sa.Column('updatedBy', sa.String(length=255), nullable=False),
    sa.ForeignKeyConstraint(['name'], ['dictionary.contentId'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    ...
    sa.ForeignKeyConstraint(['description'], ['dictionary.contentId'], ),
    sa.ForeignKeyConstraint(['title'], ['dictionary.contentId'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    ...
    sa.Column('lastUpdated', sa.TIMESTAMP(), server_default=sa.text('current_timestamp() ON UPDATE current_timestamp()'), nullable=False),
    sa.Column('updatedBy', sa.String(length=255), nullable=False),
    sa.ForeignKeyConstraint(['tag'], ['dictionary.contentId'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    ...
    sa.ForeignKeyConstraint(['description'], ['dictionary.contentId'], ),
    sa.ForeignKeyConstraint(['subTableId'], ['definitionTable.ID'], ),
    sa.ForeignKeyConstraint(['tableId'], ['definitionTable.ID'], ),
    sa.ForeignKeyConstraint(['templateSubTableId'], ['definitionTable.ID'], ),
    sa.ForeignKeyConstraint(['templateTableId'], ['definitionTable.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    ...
    sa.ForeignKeyConstraint(['description'], ['dictionary.contentId'], ),
    sa.ForeignKeyConstraint(['instruction'], ['dictionary.contentId'], ),
    sa.ForeignKeyConstraint(['nickname'], ['dictionary.contentId'], ),
    sa.ForeignKeyConstraint(['purposeId'], ['purpose.ID'], ),
    sa.ForeignKeyConstraint(['respondentId'], ['respondent.ID'], ),
    sa.ForeignKeyConstraint(['title'], ['dictionary.contentId'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    ...
    sa.ForeignKeyConstraint(['libraryId'], ['library.ID'], ),
    ...
    op.create_table('answerQuestionnaire',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    ...
    sa.Column('status', mysql.INTEGER(display_width=11), server_default=sa.text('0'), nullable=False, comment='0 = New, 1 = In Progress, 2 = Completed'),
    sa.Column('deleted', mysql.TINYINT(display_width=4), server_default=sa.text('0'), nullable=False),
    sa.Column('deletedBy', sa.String(length=255), nullable=False),
    sa.Column('creationDate', sa.DateTime(), nullable=False),
    sa.Column('createdBy', sa.String(length=255), nullable=False),
    ...
    sa.ForeignKeyConstraint(['questionnaireId'], ['questionnaire.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    ...
    op.create_index(op.f('ix_answerQuestionnaire_questionnaireId'), 'answerQuestionnaire', ['questionnaireId'], unique=False)
    ...
    sa.Column('version', mysql.INTEGER(display_width=11), server_default=sa.text('1'), nullable=False),
    sa.Column('parentId', mysql.BIGINT(display_width=20), server_default=sa.text('-1'), nullable=False),
    sa.Column('polarity', mysql.TINYINT(display_width=4), server_default=sa.text('0'), nullable=False, comment='0 = lowGood (the lower the score, the better the answer), 1 = highGood (the higher the score, the better the answer)'),
    sa.Column('private', mysql.TINYINT(display_width=4), server_default=sa.text('0'), nullable=False),
    sa.Column('final', mysql.TINYINT(display_width=4), server_default=sa.text('0'), nullable=False),
    ...
    sa.Column('lastUpdated', sa.TIMESTAMP(), server_default=sa.text('current_timestamp() ON UPDATE current_timestamp()'), nullable=False),
    sa.Column('updatedBy', sa.String(length=255), nullable=False),
    sa.Column('legacyTypeId', mysql.BIGINT(display_width=20), nullable=False, comment='This ID linked to the legacyTypes table must be removed once the migration of the legacy questionnaire will be done and the triggers stopped.'),
    sa.ForeignKeyConstraint(['definition'], ['dictionary.contentId'], ),
    sa.ForeignKeyConstraint(['display'], ['dictionary.contentId'], ),
    sa.ForeignKeyConstraint(['legacyTypeId'], ['legacyType.ID'], ),
    sa.ForeignKeyConstraint(['question'], ['dictionary.contentId'], ),
    sa.ForeignKeyConstraint(['typeId'], ['type.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    ...
    op.create_table('questionnaireFeedback',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('questionnaireId', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('languageId', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('patientId', mysql.BIGINT(display_width=20), nullable=False),
    ...
    op.create_index(op.f('ix_questionnaireFeedback_questionnaireId'), 'questionnaireFeedback', ['questionnaireId'], unique=False)
    op.create_table('questionnaireRating',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('questionnaireId', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('languageId', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('patientId', mysql.BIGINT(display_width=20), nullable=False),
    ...
    op.create_index(op.f('ix_questionnaireRating_questionnaireId'), 'questionnaireRating', ['questionnaireId'], unique=False)
    ...
    op.create_table('templateQuestionCheckbox',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    ...
    sa.ForeignKeyConstraint(['templateQuestionId'], ['templateQuestion.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    op.create_index(op.f('ix_templateQuestionCheckbox_templateQuestionId'), 'templateQuestionCheckbox', ['templateQuestionId'], unique=False)
    op.create_table('templateQuestionDate',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('templateQuestionId', mysql.BIGINT(display_width=20), nullable=False),
    sa.ForeignKeyConstraint(['templateQuestionId'], ['templateQuestion.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    op.create_index(op.f('ix_templateQuestionDate_templateQuestionId'), 'templateQuestionDate', ['templateQuestionId'], unique=False)
    op.create_table('templateQuestionLabel',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('templateQuestionId', mysql.BIGINT(display_width=20), nullable=False),
    ...
    op.create_index(op.f('ix_templateQuestionLabel_templateQuestionId'), 'templateQuestionLabel', ['templateQuestionId'], unique=False)
    op.create_table('templateQuestionRadioButton',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('templateQuestionId', mysql.BIGINT(display_width=20), nullable=False),
    sa.ForeignKeyConstraint(['templateQuestionId'], ['templateQuestion.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    op.create_index(op.f('ix_templateQuestionRadioButton_templateQuestionId'), 'templateQuestionRadioButton', ['templateQuestionId'], unique=False)
    op.create_table('templateQuestionSlider',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('templateQuestionId', mysql.BIGINT(display_width=20), nullable=False),
    ...
    sa.ForeignKeyConstraint(['maxCaption'], ['dictionary.contentId'], ),
    sa.ForeignKeyConstraint(['minCaption'], ['dictionary.contentId'], ),
    sa.ForeignKeyConstraint(['templateQuestionId'], ['templateQuestion.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    op.create_index(op.f('ix_templateQuestionSlider_maxCaption'), 'templateQuestionSlider', ['maxCaption'], unique=False)
    op.create_index(op.f('ix_templateQuestionSlider_minCaption'), 'templateQuestionSlider', ['minCaption'], unique=False)
    op.create_index(op.f('ix_templateQuestionSlider_templateQuestionId'), 'templateQuestionSlider', ['templateQuestionId'], unique=False)
    op.create_table('templateQuestionTextBox',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('templateQuestionId', mysql.BIGINT(display_width=20), nullable=False),
    sa.ForeignKeyConstraint(['templateQuestionId'], ['templateQuestion.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    op.create_index(op.f('ix_templateQuestionTextBox_templateQuestionId'), 'templateQuestionTextBox', ['templateQuestionId'], unique=False)
    op.create_table('templateQuestionTime',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('templateQuestionId', mysql.BIGINT(display_width=20), nullable=False),
    sa.ForeignKeyConstraint(['templateQuestionId'], ['templateQuestion.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    op.create_index(op.f('ix_templateQuestionTime_templateQuestionId'), 'templateQuestionTime', ['templateQuestionId'], unique=False)
    op.create_table('answerSection',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    ...
    sa.ForeignKeyConstraint(['answerQuestionnaireId'], ['answerQuestionnaire.ID'], ),
    sa.ForeignKeyConstraint(['sectionId'], ['section.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    op.create_index(op.f('ix_answerSection_answerQuestionnaireId'), 'answerSection', ['answerQuestionnaireId'], unique=False)
    ...
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('questionId', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('displayIntensity', mysql.TINYINT(display_width=4), server_default=sa.text('0'), nullable=False, comment='0 = patient cannot select intensity, 1 = patient can select intensity'),
    sa.Column('pathImage', sa.String(length=512), nullable=False),
    sa.ForeignKeyConstraint(['questionId'], ['question.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    op.create_index(op.f('ix_label_questionId'), 'label', ['questionId'], unique=False)
    op.create_table('libraryQuestion',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('questionId', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('libraryId', mysql.BIGINT(display_width=20), nullable=False),
    sa.ForeignKeyConstraint(['libraryId'], ['library.ID'], ),
    ...
    op.create_table('questionFeedback',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('questionId', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('languageId', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('patientId', mysql.BIGINT(display_width=20), nullable=False),
    ...
    op.create_table('questionRating',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('questionId', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('languageId', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('patientId', mysql.BIGINT(display_width=20), nullable=False),
    ...
    sa.Column('sectionId', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('order', mysql.INTEGER(display_width=11), server_default=sa.text('1'), nullable=False),
    sa.Column('orientation', mysql.INTEGER(display_width=11), server_default=sa.text('0'), nullable=False, comment='0 = Portrait, 1 = Landscape, 2 = Both'),
    sa.Column('optional', mysql.TINYINT(display_width=4), server_default=sa.text('0'), nullable=False, comment='0 = false, 1 = true'),
    sa.ForeignKeyConstraint(['questionId'], ['question.ID'], ),
    sa.ForeignKeyConstraint(['sectionId'], ['section.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    ...
    op.create_table('templateQuestionCheckboxOption',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('parentTableId', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('description', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('order', mysql.INTEGER(display_width=11), server_default=sa.text('1'), nullable=False),
    sa.Column('specialAction', mysql.INTEGER(display_width=11), nullable=False, comment='0 = nothing special, 1 = check everything, 2 = uncheck everything'),
    sa.ForeignKeyConstraint(['description'], ['dictionary.contentId'], ),
    sa.ForeignKeyConstraint(['parentTableId'], ['templateQuestionCheckbox.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    op.create_index(op.f('ix_templateQuestionCheckboxOption_description'), 'templateQuestionCheckboxOption', ['description'], unique=False)
    op.create_index(op.f('ix_templateQuestionCheckboxOption_parentTableId'), 'templateQuestionCheckboxOption', ['parentTableId'], unique=False)
    op.create_table('templateQuestionLabelOption',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('parentTableId', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('description', mysql.BIGINT(display_width=20), nullable=False),
    ...
    sa.Column('order', mysql.INTEGER(display_width=11), server_default=sa.text('1'), nullable=False),
    sa.ForeignKeyConstraint(['description'], ['dictionary.contentId'], ),
    sa.ForeignKeyConstraint(['parentTableId'], ['templateQuestionLabel.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    op.create_index(op.f('ix_templateQuestionLabelOption_description'), 'templateQuestionLabelOption', ['description'], unique=False)
    op.create_index(op.f('ix_templateQuestionLabelOption_parentTableId'), 'templateQuestionLabelOption', ['parentTableId'], unique=False)
    op.create_table('templateQuestionRadioButtonOption',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('parentTableId', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('description', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('order', mysql.INTEGER(display_width=11), server_default=sa.text('1'), nullable=False),
    sa.ForeignKeyConstraint(['description'], ['dictionary.contentId'], ),
    sa.ForeignKeyConstraint(['parentTableId'], ['templateQuestionRadioButton.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    op.create_index(op.f('ix_templateQuestionRadioButtonOption_description'), 'templateQuestionRadioButtonOption', ['description'], unique=False)
    op.create_index(op.f('ix_templateQuestionRadioButtonOption_parentTableId'), 'templateQuestionRadioButtonOption', ['parentTableId'], unique=False)
    op.create_table('templateQuestionTextBoxTrigger',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('parentTableId', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('description', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('order', mysql.INTEGER(display_width=11), server_default=sa.text('1'), nullable=False),
    sa.ForeignKeyConstraint(['description'], ['dictionary.contentId'], ),
    sa.ForeignKeyConstraint(['parentTableId'], ['templateQuestionTextBox.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    op.create_index(op.f('ix_templateQuestionTextBoxTrigger_description'), 'templateQuestionTextBoxTrigger', ['description'], unique=False)
    op.create_index(op.f('ix_templateQuestionTextBoxTrigger_parentTableId'), 'templateQuestionTextBoxTrigger', ['parentTableId'], unique=False)
    ...
    sa.Column('lastUpdated', sa.TIMESTAMP(), server_default=sa.text('current_timestamp() ON UPDATE current_timestamp()'), nullable=False),
    sa.Column('updatedBy', sa.String(length=255), nullable=False),
    sa.ForeignKeyConstraint(['answerSectionId'], ['answerSection.ID'], ),
    sa.ForeignKeyConstraint(['languageId'], ['language.ID'], ),
    sa.ForeignKeyConstraint(['patientId'], ['patient.ID'], ),
    sa.ForeignKeyConstraint(['questionId'], ['question.ID'], ),
    sa.ForeignKeyConstraint(['questionnaireId'], ['questionnaire.ID'], ),
    ...
    op.create_table('checkboxOption',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('parentTableId', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('order', mysql.INTEGER(display_width=11), server_default=sa.text('1'), nullable=False),
    sa.Column('description', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('specialAction', mysql.INTEGER(display_width=11), server_default=sa.text('0'), nullable=False, comment='0 = nothing special, 1 = check everything, 2 = uncheck everything'),
    sa.ForeignKeyConstraint(['description'], ['dictionary.contentId'], ),
    sa.ForeignKeyConstraint(['parentTableId'], ['checkbox.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    ...
    sa.Column('order', mysql.INTEGER(display_width=11), server_default=sa.text('1'), nullable=False),
    sa.ForeignKeyConstraint(['description'], ['dictionary.contentId'], ),
    sa.ForeignKeyConstraint(['parentTableId'], ['label.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    ...
    op.create_table('radioButtonOption',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('parentTableId', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('description', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('order', mysql.INTEGER(display_width=11), server_default=sa.text('1'), nullable=False),
    sa.ForeignKeyConstraint(['description'], ['dictionary.contentId'], ),
    sa.ForeignKeyConstraint(['parentTableId'], ['radioButton.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    ...
    op.create_table('textBoxTrigger',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('parentTableId', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('description', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('order', mysql.INTEGER(display_width=11), server_default=sa.text('1'), nullable=False),
    sa.ForeignKeyConstraint(['description'], ['dictionary.contentId'], ),
    sa.ForeignKeyConstraint(['parentTableId'], ['textBox.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    ...
    op.create_table('answerCheckbox',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    ...
    sa.ForeignKeyConstraint(['value'], ['checkboxOption.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    ...
    sa.Column('value', mysql.BIGINT(display_width=20), nullable=False),
    sa.ForeignKeyConstraint(['answerId'], ['answer.ID'], ),
    sa.ForeignKeyConstraint(['value'], ['labelOption.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
    ...
    op.create_table('answerRadioButton',
    sa.Column('ID', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('answerId', mysql.BIGINT(display_width=20), nullable=False),
    sa.Column('value', mysql.BIGINT(display_width=20), nullable=False),
    sa.ForeignKeyConstraint(['answerId'], ['answer.ID'], ),
    sa.ForeignKeyConstraint(['value'], ['radioButtonOption.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_templateQuestionRadioButtonOption_parentTableId'), table_name='templateQuestionRadioButtonOption')
    op.drop_index(op.f('ix_templateQuestionRadioButtonOption_description'), table_name='templateQuestionRadioButtonOption')
